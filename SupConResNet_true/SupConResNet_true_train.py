...
from SupConResNet_true_model import SupConResNet
import glob
from tensorflow.keras.callbacks import CSVLogger, ModelCheckpoint, EarlyStopping, ReduceLROnPlateau
import joblib
from DataLoader_true_pair import DataGenerator_pair
...
if __name__ == '__main__':
    ...
    # 配置 CSVLogger 回调
    csv_logger = CSVLogger('../log/SupConResNet_true.csv', append=False)
    ...
    history = model.fit(
        ...
        epochs=100,
        callbacks=[
            ModelCheckpoint('../model/best_SupConResNet_true_model.h5', save_best_only=True,
